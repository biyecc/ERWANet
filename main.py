import argparse
import os
from SophisticatedOne import SophisticatedModel
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="results/2_5", type=str)  #####################################
    parser.add_argument("--num_layers", default=4, type=int)
    parser.add_argument("--graph_path", default="/data/CC/MKExamplarsTMP/graph/2_5", type=str)  ###############################
    parser.add_argument("--global_embed", default=True, type=bool)  ##########
    parser.add_argument("--edge_embed", default=True, type=bool)  ########
